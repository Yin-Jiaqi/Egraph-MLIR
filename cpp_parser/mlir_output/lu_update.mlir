  ...
  func.func @kernel_lu(%arg0: i32, %arg1: memref<?x2000xf64>) attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    affine.for %arg2 = 0 to %0 {
      affine.for %arg3 = 0 to #map(%arg2) {
        ...
        %6 = affine.load %arg1[%arg3, %arg3] : memref<?x2000xf64>
        %7 = affine.load %arg1[%arg2, %arg3] : memref<?x2000xf64>
        %8 = arith.divf %7, %6 : f64
        affine.store %8, %arg1[%arg2, %arg3] : memref<?x2000xf64>
      }
      affine.for %arg5 = #map(%arg2) to %0 {
        affine.for %arg6 = 0 to #map(%arg2) {
          %9 = affine.load %arg1[%arg2, %arg6] : memref<?x2000xf64>
          %10 = affine.load %arg1[%arg6, %arg5] : memref<?x2000xf64>
          %11 = arith.mulf %9, %10 : f64
          %12 = affine.load %arg1[%arg2, %arg5] : memref<?x2000xf64>
          %13 = arith.subf %12, %11 : f64
          affine.store %13, %arg1[%arg2, %arg5] : memref<?x2000xf64>
        }
      }
    }
    return
